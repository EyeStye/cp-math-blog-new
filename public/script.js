...
`;
  ...
  class="bg-white dark:bg-black dark:border dark:border-violet-500/30 dark:hover:border-violet-500/50 rounded-xl shadow-sm p-6 hover:shadow-md transition cursor-pointer dark:hover:backdrop-blur-xl dark:hover:bg-violet-500/10"
>
